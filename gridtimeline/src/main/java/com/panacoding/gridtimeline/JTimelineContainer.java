...
public class JTimelineContainer extends RelativeLayout {
    private Activity activity;
    private LayoutInflater inflater;

    private List<JModelYLabel> yLabels;
    ...
    // Text colors
    private String labels_text_color = "#8d99ae";
    ...
    public String getLabels_text_color() {
        return labels_text_color;
    }

    public void setLabels_text_color(String labels_text_color) {
        this.labels_text_color = labels_text_color;
    }

    public String getColor_background_timeline() {
        return color_background_timeline;
    }

    public void setColor_background_timeline(String color_background_timeline) {
        this.color_background_timeline = color_background_timeline;
    }

    public int getInner_line_col_multiplier() {
        return inner_line_col_multiplier;
    }

    public void setInner_line_col_multiplier(int inner_line_col_multiplier) {
        this.inner_line_col_multiplier = inner_line_col_multiplier;
    }

    public String getStroke_color_grid() {
        return stroke_color_grid;
    }

    public void setStroke_color_grid(String stroke_color_grid) {
        this.stroke_color_grid = stroke_color_grid;
    }

    public void setRows_labels_width(int rows_labels_width) {
        this.rows_labels_width = rows_labels_width;
    }

    public void setDate_format_to_show(String date_format_to_show) {
    ...
    public void setX_axis_in_hours(boolean x_axis_in_hours) {
        this.x_axis_in_hours = x_axis_in_hours;
    }

    public void setShow_actual_hour_indicator(boolean show_actual_hour_indicator) {
        this.show_actual_hour_indicator = show_actual_hour_indicator;
    }

    public void setEnd_hour_24(int end_hour_24) {
        if(end_hour_24<=24) {
            this.end_hour_24 = end_hour_24;
        }
    }

    public void setStart_hour_24(int start_hour_24) {
        if(start_hour_24>0) {
            this.start_hour_24 = start_hour_24;
        }
    }

    public void setInterval_mins(int interval_mins) {
    ...
    public void setEvents(JModelEvent[] events) {
        this.events = events;
    }
    ...
    public void setyLabels(List<JModelYLabel> yLabels) {
        this.yLabels = yLabels;
    }

    public void setyLabelsTitle(String yLabelsTitle) {
        this.yLabelsTitle = yLabelsTitle;
    }

    public JTimelineContainer(Context context) {
        super(context);
        init();
    }

    public JTimelineContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public JTimelineContainer(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public JTimelineContainer(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(){
        ...
        View jtimeline = inflater.inflate(R.layout.layout_jtimelinecontainer,this,false);
    ...
    public void load(){
        ...
        // Title y labels
        TextView tw_Ytitle = (TextView) inflater.inflate(R.layout.layout_jtimeline_y_row_label,this,false);
        ...
        if( yLabels!=null && yLabels.size()>0 ){
            ...
            for(JModelYLabel jModelYLabel : yLabels){
                TextView tw_y_row_label = (TextView) inflater.inflate(R.layout.layout_jtimeline_y_row_label,this,false);
        ...
        if(x_axis_in_hours) {
            ...
            while (hour_start_x <= end_hour_24) {
                ...
                TextView tw_x_col_label = (TextView) inflater.inflate(R.layout.layout_jtimeline_x_col_label, this, false);
        ...
        jGridDraw.setOnCellSizeChange(new JGridDraw.OnCellSizeChange() {
            ...
            public void onCellSizeChange(float cell_width, float cell_height) {
                JTimelineContainer.this.cell_width = cell_width;
                JTimelineContainer.this.cell_height = cell_height;
